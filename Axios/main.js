...
function getTodos() {
    ...
    //     }
    // })
    axios.get("https://jsonplaceholder.typicode.com/todos?_limit=5",{timeout:10000})
  ...
  function errorHandling() {
    ...
    .catch(err=>{
        if(err.response)
        {
            // server responded with status range other than 200.
  ...
  axoisinstance.get("/comments").then(res=>showOutput(res))
